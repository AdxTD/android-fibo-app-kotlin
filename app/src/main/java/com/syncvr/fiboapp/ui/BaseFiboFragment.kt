 ...
 * Use the [BaseFiboFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
abstract class BaseFiboFragment : Fragment() {

    protected lateinit var viewModel: FiboRequestsViewModel
    protected lateinit var recyclerView: RecyclerView

    protected val maxFiboNumberAllowed = 92
    protected var fiboNumberIndex = 0
